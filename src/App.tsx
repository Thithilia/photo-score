...
const storeItems: StoreItem[] = [
  ...
  },
  {
    ...
    category: 'food',
    name: 'Nước suối',
    description: 'Một chai nhỏ để đổi nhanh sau ngày bận.',
    price: 1,
    icon: Utensils,
  },
  {
    ...
    category: 'food',
    name: 'Sữa chua',
    description: 'Món nhẹ mát và dễ thưởng.',
    price: 2,
    icon: Utensils,
  },
  {
    ...
    category: 'food',
    name: 'Bánh bao',
    description: 'Một phần no nhẹ cho buổi sáng.',
    price: 3,
    icon: Utensils,
  },
  {
    ...
    description: 'Món ăn vặt giòn cho cuối ngày.',
    price: 4,
    icon: Utensils,
  },
  {
    ...
    category: 'food',
    name: 'Salad',
    description: 'Một bát xanh nhẹ để cân bằng.',
    price: 4,
    icon: Utensils,
  },
  {
    ...
    category: 'food',
    name: 'Phở nhỏ',
    description: 'Một tô quen thuộc cho ngày cần nạp sức.',
    price: 5,
    icon: Utensils,
  },
  {
    ...
    category: 'food',
    name: 'Cơm tấm',
    description: 'Một phần chắc bụng sau giờ làm.',
    price: 6,
    icon: Utensils,
  },
  {
    ...
    category: 'food',
    name: 'Takoyaki',
    description: 'Món ăn vặt nhỏ nhưng vui.',
    price: 6,
    icon: Utensils,
  },
  {
    ...
    category: 'food',
    name: 'Burger',
    description: 'Một phần no nhanh cho ngày dài.',
    price: 7,
    icon: Utensils,
  },
  {
    ...
    category: 'food',
    name: 'Bánh xèo',
    description: 'Món giòn thơm cho bữa đặc biệt.',
    price: 7,
    icon: Utensils,
  },
  {
    ...
    category: 'food',
    name: 'Mì Ý',
    description: 'Một đĩa nhỏ cho tối đổi vị.',
    price: 8,
    icon: Utensils,
  },
  {
    ...
    category: 'food',
    name: 'Ramen',
    description: 'Một tô đậm vị cho ngày lạnh.',
    price: 9,
    icon: Utensils,
  },
  {
    id: 'dessert-box',
    category: 'food',
    name: 'Hộp tráng miệng',
    description: 'Một hộp ngọt nhỏ để ăn chung.',
    price: 5,
    icon: Utensils,
  },
  {
    ...
    category: 'food',
    name: 'BBQ combo',
    description: 'Một phần lớn để dành khi nhiều cá hơn.',
    price: 13,
    icon: Utensils,
  },
  {
