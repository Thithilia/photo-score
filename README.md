...
- Giá thực phẩm được cân theo thu nhập `5 cá / ảnh`: cà phê `1 cá`, món ăn thường vài cá, món lớn khoảng hơn 2-3 ảnh. Nội thất đắt hơn để tạo mục tiêu tích lũy dài hơn.
...
- Google token chỉ nằm trong phiên trình duyệt hiện tại. Trong lúc tab còn mở, app sẽ tự thử làm mới token khi upload ảnh, lưu dữ liệu hoặc tải lại dữ liệu chung.
- Nếu Google không cho làm mới im lặng, ví dụ phiên Google đã hết hạn hoặc quyền bị thu hồi, bấm `Kết nối Drive` lại.
